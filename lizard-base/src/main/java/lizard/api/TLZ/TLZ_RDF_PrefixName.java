...
public class TLZ_RDF_PrefixName implements org.apache.thrift.TBase<TLZ_RDF_PrefixName, TLZ_RDF_PrefixName._Fields>, java.io.Serializable, Cloneable, Comparable<TLZ_RDF_PrefixName> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TLZ_RDF_PrefixName");
  ...
  static {
    schemes.put(StandardScheme.class, new TLZ_RDF_PrefixNameStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TLZ_RDF_PrefixNameTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TLZ_RDF_PrefixName.class, metaDataMap);
  }

  public TLZ_RDF_PrefixName() {
  }
   ...
   */
  public TLZ_RDF_PrefixName(TLZ_RDF_PrefixName other) {
  ...
  public TLZ_RDF_PrefixName deepCopy() {
    return new TLZ_RDF_PrefixName(this);
  }
  ...
  public TLZ_RDF_PrefixName setPrefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public TLZ_RDF_PrefixName setLocalName(String localName) {
    this.localName = localName;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TLZ_RDF_PrefixName)
      return this.equals((TLZ_RDF_PrefixName)that);
    return false;
  }

  public boolean equals(TLZ_RDF_PrefixName that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TLZ_RDF_PrefixName other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TLZ_RDF_PrefixName(");
    boolean first = true;
  ...
  private static class TLZ_RDF_PrefixNameStandardSchemeFactory implements SchemeFactory {
    public TLZ_RDF_PrefixNameStandardScheme getScheme() {
      return new TLZ_RDF_PrefixNameStandardScheme();
    }
  }

  private static class TLZ_RDF_PrefixNameStandardScheme extends StandardScheme<TLZ_RDF_PrefixName> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TLZ_RDF_PrefixName struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TLZ_RDF_PrefixName struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TLZ_RDF_PrefixNameTupleSchemeFactory implements SchemeFactory {
    public TLZ_RDF_PrefixNameTupleScheme getScheme() {
      return new TLZ_RDF_PrefixNameTupleScheme();
    }
  }

  private static class TLZ_RDF_PrefixNameTupleScheme extends TupleScheme<TLZ_RDF_PrefixName> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TLZ_RDF_PrefixName struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TLZ_RDF_PrefixName struct) throws org.apache.thrift.TException {
