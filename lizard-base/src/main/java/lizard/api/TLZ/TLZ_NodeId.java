...
public class TLZ_NodeId implements org.apache.thrift.TBase<TLZ_NodeId, TLZ_NodeId._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TLZ_NodeId other) {
    ...
    TLZ_NodeId typedOther = (TLZ_NodeId)other;
