...
public class TLZ_Ping implements org.apache.thrift.TBase<TLZ_Ping, TLZ_Ping._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TLZ_Ping other) {
    ...
    TLZ_Ping typedOther = (TLZ_Ping)other;

    lastComparison = Boolean.valueOf(isSetMarker()).compareTo(typedOther.isSetMarker());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMarker()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.marker, typedOther.marker);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
