...
public class TLZ_SubjectPredicateObjectList implements org.apache.thrift.TBase<TLZ_SubjectPredicateObjectList, TLZ_SubjectPredicateObjectList._Fields>, java.io.Serializable, Cloneable {
  ...
  public TLZ_SubjectPredicateObjectList(TLZ_SubjectPredicateObjectList other) {
    ...
    if (other.isSetObjects()) {
      List<Long> __this__objects = new ArrayList<Long>();
      for (Long other_element : other.objects) {
        __this__objects.add(other_element);
      }
  ...
  public int compareTo(TLZ_SubjectPredicateObjectList other) {
    ...
    TLZ_SubjectPredicateObjectList typedOther = (TLZ_SubjectPredicateObjectList)other;
