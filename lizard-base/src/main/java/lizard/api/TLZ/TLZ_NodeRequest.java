...
public class TLZ_NodeRequest implements org.apache.thrift.TBase<TLZ_NodeRequest, TLZ_NodeRequest._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TLZ_NodeRequest other) {
    ...
    TLZ_NodeRequest typedOther = (TLZ_NodeRequest)other;
    ...
    lastComparison = Boolean.valueOf(isSetFindByNode()).compareTo(typedOther.isSetFindByNode());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFindByNode()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.findByNode, typedOther.findByNode);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetAllocNodeId()).compareTo(typedOther.isSetAllocNodeId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAllocNodeId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.allocNodeId, typedOther.allocNodeId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetFindByNodeId()).compareTo(typedOther.isSetFindByNodeId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFindByNodeId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.findByNodeId, typedOther.findByNodeId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
