...
public class TLZ_RDF_Quad implements org.apache.thrift.TBase<TLZ_RDF_Quad, TLZ_RDF_Quad._Fields>, java.io.Serializable, Cloneable, Comparable<TLZ_RDF_Quad> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TLZ_RDF_Quad");
  ...
  static {
    schemes.put(StandardScheme.class, new TLZ_RDF_QuadStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TLZ_RDF_QuadTupleSchemeFactory());
  }

  public TLZ_RDF_Term S; // required
  public TLZ_RDF_Term P; // required
  public TLZ_RDF_Term O; // required
  public TLZ_RDF_Term G; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TLZ_RDF_Quad.class, metaDataMap);
  }
   ...
   */
  public TLZ_RDF_Quad(TLZ_RDF_Quad other) {
    if (other.isSetS()) {
    ...
    if (other.isSetG()) {
      this.G = new TLZ_RDF_Term(other.G);
    }
  }

  public TLZ_RDF_Quad deepCopy() {
    return new TLZ_RDF_Quad(this);
  }
  ...
  public TLZ_RDF_Quad setS(TLZ_RDF_Term S) {
    this.S = S;
    return this;
  }
  ...
  public TLZ_RDF_Quad setP(TLZ_RDF_Term P) {
    this.P = P;
    return this;
  }
  ...
  public TLZ_RDF_Quad setO(TLZ_RDF_Term O) {
    this.O = O;
    return this;
  }
  ...
  public TLZ_RDF_Term getG() {
    return this.G;
  }

  public TLZ_RDF_Quad setG(TLZ_RDF_Term G) {
    this.G = G;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TLZ_RDF_Quad)
      return this.equals((TLZ_RDF_Quad)that);
    return false;
  }

  public boolean equals(TLZ_RDF_Quad that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TLZ_RDF_Quad other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TLZ_RDF_Quad(");
    boolean first = true;
  ...
  private static class TLZ_RDF_QuadStandardSchemeFactory implements SchemeFactory {
    public TLZ_RDF_QuadStandardScheme getScheme() {
      return new TLZ_RDF_QuadStandardScheme();
    }
  }

  private static class TLZ_RDF_QuadStandardScheme extends StandardScheme<TLZ_RDF_Quad> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TLZ_RDF_Quad struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TLZ_RDF_Quad struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TLZ_RDF_QuadTupleSchemeFactory implements SchemeFactory {
    public TLZ_RDF_QuadTupleScheme getScheme() {
      return new TLZ_RDF_QuadTupleScheme();
    }
  }

  private static class TLZ_RDF_QuadTupleScheme extends TupleScheme<TLZ_RDF_Quad> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TLZ_RDF_Quad struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TLZ_RDF_Quad struct) throws org.apache.thrift.TException {
