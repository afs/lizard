...
public class TLZ_ShardIndex implements org.apache.thrift.TBase<TLZ_ShardIndex, TLZ_ShardIndex._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TLZ_ShardIndex other) {
    ...
    TLZ_ShardIndex typedOther = (TLZ_ShardIndex)other;
