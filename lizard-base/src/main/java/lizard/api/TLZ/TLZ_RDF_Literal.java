...
public class TLZ_RDF_Literal implements org.apache.thrift.TBase<TLZ_RDF_Literal, TLZ_RDF_Literal._Fields>, java.io.Serializable, Cloneable, Comparable<TLZ_RDF_Literal> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TLZ_RDF_Literal");
  ...
  static {
    schemes.put(StandardScheme.class, new TLZ_RDF_LiteralStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TLZ_RDF_LiteralTupleSchemeFactory());
  }

  public String lex; // required
  public String langtag; // optional
  public String datatype; // optional
  public TLZ_RDF_PrefixName dtPrefix; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TLZ_RDF_Literal.class, metaDataMap);
  }

  public TLZ_RDF_Literal() {
  }
   ...
   */
  public TLZ_RDF_Literal(TLZ_RDF_Literal other) {
    if (other.isSetLex()) {
      this.lex = other.lex;
    }
    ...
    if (other.isSetDtPrefix()) {
      this.dtPrefix = new TLZ_RDF_PrefixName(other.dtPrefix);
    }
  }

  public TLZ_RDF_Literal deepCopy() {
    return new TLZ_RDF_Literal(this);
  }
  ...
  public TLZ_RDF_Literal setLex(String lex) {
    this.lex = lex;
    return this;
  }
  ...
  public TLZ_RDF_Literal setLangtag(String langtag) {
  ...
  public TLZ_RDF_Literal setDatatype(String datatype) {
  ...
  public TLZ_RDF_PrefixName getDtPrefix() {
    return this.dtPrefix;
  }

  public TLZ_RDF_Literal setDtPrefix(TLZ_RDF_PrefixName dtPrefix) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DT_PREFIX:
      if (value == null) {
        ...
        setDtPrefix((TLZ_RDF_PrefixName)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TLZ_RDF_Literal)
      return this.equals((TLZ_RDF_Literal)that);
    return false;
  }

  public boolean equals(TLZ_RDF_Literal that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TLZ_RDF_Literal other) {
    ...
    lastComparison = Boolean.valueOf(isSetLex()).compareTo(other.isSetLex());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetLangtag()).compareTo(other.isSetLangtag());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLangtag()) {
    ...
    lastComparison = Boolean.valueOf(isSetDtPrefix()).compareTo(other.isSetDtPrefix());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDtPrefix()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TLZ_RDF_Literal(");
    boolean first = true;
  ...
  private static class TLZ_RDF_LiteralStandardSchemeFactory implements SchemeFactory {
    public TLZ_RDF_LiteralStandardScheme getScheme() {
      return new TLZ_RDF_LiteralStandardScheme();
    }
  }

  private static class TLZ_RDF_LiteralStandardScheme extends StandardScheme<TLZ_RDF_Literal> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TLZ_RDF_Literal struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // DT_PREFIX
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.dtPrefix = new TLZ_RDF_PrefixName();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TLZ_RDF_Literal struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TLZ_RDF_LiteralTupleSchemeFactory implements SchemeFactory {
    public TLZ_RDF_LiteralTupleScheme getScheme() {
      return new TLZ_RDF_LiteralTupleScheme();
    }
  }

  private static class TLZ_RDF_LiteralTupleScheme extends TupleScheme<TLZ_RDF_Literal> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TLZ_RDF_Literal struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TLZ_RDF_Literal struct) throws org.apache.thrift.TException {
