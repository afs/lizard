...
public class TLZ_Node implements org.apache.thrift.TBase<TLZ_Node, TLZ_Node._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TLZ_Node other) {
    ...
    TLZ_Node typedOther = (TLZ_Node)other;

    lastComparison = Boolean.valueOf(isSetNodeStr()).compareTo(typedOther.isSetNodeStr());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNodeStr()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.nodeStr, typedOther.nodeStr);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
